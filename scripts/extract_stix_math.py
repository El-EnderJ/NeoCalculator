 ...
 * Auto-generated by scripts/extract_stix_math.py.
 * Source font: {source_font}
 * Font UPM (unitsPerEm): {upm}
 *
 * STIX data: Copyright 2001-2021 The STIX Fonts Project Authors
 * (https://github.com/stipub/stixfonts), licensed under OFL-1.1.
 * NumOS table scaffolding: Copyright (C) 2026 Juan Ramon,
 * licensed under GPL-3.0-or-later.
 * SPDX-License-Identifier: GPL-3.0-or-later AND OFL-1.1
 * Full OFL text: assets/fonts/LICENSES/STIXTwoMath-OFL-1.1.txt
 *
...
def main() -> int:
    ...
    try:
        source_font = font_path.relative_to(repo_root).as_posix()
    except ValueError:
        # Do not leak a contributor's absolute machine path into generated files.
    ...
    try:
        ...
        generate_header(values, upm, str(const_path), source_font)
